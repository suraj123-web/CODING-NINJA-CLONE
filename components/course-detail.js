          ...
          <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6 border dark:border-gray-700">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                  ...
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{courseData.title}</h1>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">by {courseData.instructor}</p>
                  <p className="text-gray-700 dark:text-gray-300 mb-6">{courseData.description}</p>

                  <div className="flex items-center space-x-6 text-sm text-gray-600 dark:text-gray-300 mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                ...
                <Card className="dark:bg-gray-800 dark:border-gray-700">
                  <CardHeader>
                    <CardTitle className="dark:text-white">Instructor</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 dark:text-white">{courseData.instructor}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-300">Senior React Developer</p>
                      </div>
                    </div>
                ...
                <Card className="dark:bg-gray-800 dark:border-gray-700">
                  <CardHeader>
                    <CardTitle className="dark:text-white">Resources</CardTitle>
                  </CardHeader>
                  <CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-semibold dark:text-gray-300">12.5 hours</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-300">Certificates</span>
                        <span className="text-sm font-semibold dark:text-gray-300">0/1</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
